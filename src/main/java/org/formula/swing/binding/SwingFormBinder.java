...
public class SwingFormBinder extends AbstractFormBinder implements FocusListener {
	...
	@Override
	protected FormFieldBinding bindFormField(Object formField, String property, String labelProperty, String optionsProperty, boolean required, Converter converter) {
		if (formField instanceof JComponent) {
			((JComponent) formField).addFocusListener(this);
		}
		if (formField instanceof JLabel) {
			return new JLabelBinding((JLabel) formField, this, getPropertyMap(), property, labelProperty, optionsProperty, required, converter);
		} else if (formField instanceof JTextComponent) {
			return new JTextComponentBinding((JTextComponent) formField, this, getPropertyMap(), property, labelProperty, optionsProperty, required, converter);
		} else if (formField instanceof JComboBox) {
			return new JComboBoxBinding((JComboBox) formField, this, getPropertyMap(), property, labelProperty, optionsProperty, required, converter);
		} else if (formField instanceof JCheckBox) {
			return new JCheckBoxBinding((JCheckBox) formField, this, getPropertyMap(), property, labelProperty, optionsProperty, required, converter);
		} else if (formField instanceof JRadioButton) {
			return new JRadioButtonBinding((JRadioButton) formField, this, getPropertyMap(), property, labelProperty, optionsProperty, required, converter);
		} else if (formField instanceof JList) {
			return new JListBinding((JList) formField, this, getPropertyMap(), property, labelProperty, optionsProperty, required, converter);
		} else if (formField instanceof JSlider) {
			return new JSliderBinding((JSlider) formField, this, getPropertyMap(), property, labelProperty, optionsProperty, required, converter);
		} else if (formField instanceof JSpinner) {
			return new JSpinnerBinding((JSpinner) formField, this, getPropertyMap(), property, labelProperty, optionsProperty, required, converter);
		} else if (formField instanceof JProgressBar) {
			return new JProgressBarBinding((JProgressBar) formField, this, getPropertyMap(), property, labelProperty, optionsProperty, required, converter);
		} else if (formField instanceof JColorChooser) {
			return new JColorChooserBinding((JColorChooser) formField, this, getPropertyMap(), property, labelProperty, optionsProperty, required, converter);
		}
